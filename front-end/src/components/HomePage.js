...
function HomePage() {
    return (
        <div className="home">
            ...
            <div className="modules-ip-container">
                <div className="module-ip">Module 1</div>
                <div classNameName="module-ip">Module 2</div>
                <div className="module-ip">Module 3</div>
                <div className="module-ip">Module 4</div>
                <div className="module-ip">Module 5</div>
                <div className="module-ip">Module 6</div>
            </div> */}
            <div className="left-column">
                ...
                <ul className="lower">
                    ...
                    <li className="content">Module 1</li>
                    <li className="content">Module 2</li>
                    <li className="content">Module 3</li>
                    <li className="content">Module 4</li>
                </ul>
                <ul className="upper">
                    <h3>Upper-Beginner Level</h3>
                    <p><i>Recommended for: Grades 4-5</i></p>
                    <li className="content"><a href="/maze">Program a Maze with Paper</a></li>
                    <li className="content">Module 2</li>
                    <li className="content">Module 3</li>
                    <li className="content">Module 4</li>
                </ul>
                <ul className="proficient">
                    <h3>Proficient Level</h3>
                    <p><i>Recommended for: Grades 6-8</i></p>
                    <li className="content"><a href="/cryptography">Introduction to Cryptography</a></li>
                    <li className="content"><a href="/scratch">Introduction to Scratch</a></li>
                    <li className="content"><a href="/makecode">Introduction to MakeCode</a></li>
                    <li className="content">Module 4</li>
                </ul>
                <ul className="advanced">
                    <h3>Advanced Level</h3>
                    <p><i>Recommended for: Grades 9-12</i></p>
                    <li className="content"><a href="/cybersecurity">Introduction to Cybersecurity</a></li>
                    <li className="content">Module 2</li>
                    <li className="content">Module 3</li>
                    <li className="content">Module 4</li>
                </ul>
